...
if ( ! function_exists( 'woodmart_vc_map_single_product_linked_variations' ) ) {
	/**
	 * Content map.
	 */
	function woodmart_vc_map_single_product_linked_variations() {
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_single_product_linked_variations' );
}

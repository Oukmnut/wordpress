...
if ( ! function_exists( 'woodmart_vc_map_shop_archive_extra_description' ) ) {
	/**
	 * Archive description map.
	 */
	function woodmart_vc_map_shop_archive_extra_description() {
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_shop_archive_extra_description' );
}
